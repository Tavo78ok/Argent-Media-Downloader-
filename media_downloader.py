...
class MainWindow(Adw.ApplicationWindow):
    ...
    def _flush_log(self):
        ...
        if n > LOG_MAX_LINES:
            ...
            # Desempaquetamos la tupla (success, iter) que retorna GTK4
            _, c = self.log_buffer.get_iter_at_line(n - LOG_MAX_LINES)
    ...
    def _build_cmd(self, url):
        ...
        if mode == "audio":
            ...
            if has_ffmpeg:
                # Regla mejorada para forzar HD combinando video y audio
                if q == "best":
                    f_sel = "bv*+ba/b"
                else:
                ...
                # Fallback sin ffmpeg (limitado por YouTube a 360p/720p max)
